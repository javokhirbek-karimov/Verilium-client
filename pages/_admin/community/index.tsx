...
import {
  ...
  BoardArticleUpdate,
} from "../../../libs/types/board-article/board-articles.input";
import { BoardArticle } from "../../../libs/types/board-article/board-article";
import {
  BoardArticleCategory,
  BoardArticleStatus,
} from "../../../libs/enums/board-article.enum";
import { sweetConfirmAlert, sweetErrorHandling } from "../../../libs/sonner";
import {
  REMOVE_BOARD_ARTICLE_BY_ADMIN,
  UPDATE_BOARD_ARTICLE_BY_ADMIN,
} from "../../../apollo/user/mutation";
import { useMutation, useQuery } from "@apollo/client";
import { GET_ALL_BOARD_ARTICLES_BY_ADMIN } from "../../../apollo/user/query";
...
const AdminCommunity: NextPage = ({ initialInquiry }: any) => {
  ...
  const { refetch: getAllBoardArticlesByAdminRefetch } = useQuery(
  ...
  const menuIconClickHandler = (e: any, id: string) => {
  ...
  const tabChangeHandler = async (_: any, newValue: string) => {
    ...
    switch (newValue) {
      ...
      case "DELETED":
        setCommunityInquiry({
          ...communityInquiry,
          search: { articleStatus: BoardArticleStatus.DELETED },
        });
        break;
      default:
